...
https://github.com/bfred-it/iphone-inline-video
 Â© Federico Brigante https://twitter.com/bfred_it
License: MIT
*/
    ...
    var Map = (
        function() {
            ...
            function addPinToMap($item, archive) {
                ...
                // show all markers in the visible map 
                ...
                for (let locate of listinglocations) {
                    ...
                    if (typeof archive !== "undefined") {
                        ...
                        m.bindPopup(
                            "<a class='popup' href='" + $item.data('permalink') + "'>" +
                            "<div class='popup__image'><img src=" + $item.data('img') + " /></div>" +
                            "<div class='popup__content'>" +
                            "<h3 class='popup__title'>" + $item.find('.card__title').html() + "</h3>" +
                            "<div class='popup__footer'>" +
                            ratingHTML +
